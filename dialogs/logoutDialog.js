            ...
            if (text === 'logout') {
                ...
                try {
                    ...
                    if (userTokenClient) {
                        ...
                        // Actualizar estado en el bot
                        const bot = innerDc.context.turnState.get('bot');
                        if (bot && typeof bot.logoutUser === 'function') {
                            bot.logoutUser(activity.from.id);
                        }
                        
                        await innerDc.context.sendActivity('Has cerrado sesión correctamente. Escribe "login" para iniciar sesión nuevamente.');
